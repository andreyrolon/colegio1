                                    ...
                                    <div class="box box-solid" style=" box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
                                        ...
                                        <div class="box-body no-padding">
                                            <ul class="nav nav-pills nav-stacked">
                                                <li class="active"><a href="recividos.php"><i class="fa    fa-folder-o"></i> Bandeja de entrada
                                                        <?php if ($mensaje[0]>0){ ?>
                                        ...
                                        <div class="box-header with-border">
                                            ...
                                            <div class="box-tools pull-right">
                                                <div class="has-feedback">
                                                    ...
                                                    <span class="fa fa-search form-control-feedback" style="color: #c1c1c1 "></span>
                                                </div>
    ...
    <script>
        ...
        for (var i = 0; i < 100; i++) {
            function myFunction(i) {
                ...
                $.ajax({
                    type: "post",
                    url: "../../../ajax/alumno/tabla_mensaje.php?action=tabla",
                    data: {
                        i,
                        dato,
                        mySelect,
