...
include "../../../codes/rector/conexion.php"; 
    ...
    $tipo_calificaiones="SELECT   alumnos.nombre,alumnos.apellido,tecnologia.id_tecnologia,tecnologia.nota FROM tecnologia,alumnos,informeacademico WHERE informeacademico.ano='$ano' and  alumnos.id_alumnos=informeacademico.id_alumno AND tecnologia.id_informe_academico=informeacademico.id_informe_academico and informeacademico.id_grado='".$_GET['id_g']."'  and informeacademico.id_curso='".$_GET['id_c']."'   and informeacademico.id_jornada_sede='".$_GET['id_jornada_sede']."' AND tecnologia.id_competrencia='".$_GET['id']."' order by alumnos.apellido";
