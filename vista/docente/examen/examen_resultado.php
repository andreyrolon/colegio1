        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <?php
                    $sql="SELECT * FROM `examen_pregunta` WHERE id_notas_independientes=$resultado";
                    $sql1=$conexion->prepare($sql);
                    $sql1->execute(array());
                    $con4=$sql1->fetchAll();
                    $co=0; $in=0; $promedio=0;
                    foreach($con4 as $var){
                        $sql="SELECT * FROM `examen_respuesta` WHERE id_examen_pregunta=$var[0] AND id_alumno=$key[0]";
                        $sql1=$conexion->prepare($sql);
                        $sql1->execute(array());
                        $con3=$sql1->fetchAll();
                        foreach($con3 as $va){
                    ...
                    $query = "SELECT MAX(hasta) FROM `escala_academica` ORDER BY `desde` ASC";
                            ...
                            <div class="modal-dialog" role="document" style="padding-right: 1161px !important;">
                                <div class="modal-content" style="width: 1237px;">
                                    ...
                                    <div class="modal-body">
                                        <?php
                                        $sql="SELECT examen_pregunta.*, examen_respuesta.respuesta FROM `examen_pregunta` INNER JOIN examen_respuesta ON examen_respuesta.id_examen_pregunta=examen_pregunta.id WHERE examen_pregunta.id_notas_independientes=$resultado AND examen_respuesta.id_alumno=$key[0]";
                                        $sql1=$conexion->prepare($sql);
                                        $sql1->execute(array());
                                        $exa=$sql1->fetchAll();
                                        $n=0;
                                        foreach($exa as $exa1){
                                            ...
                                            <div class="col-md-6" style="height: 342px; border: 1px solid #367fa9;">
                                                <table class="table table-striped table-condensed table-hover">
                                                    ...
                                                    <?php if($exa1['respuestaCorecta'] == 1){ ?>
                                                    ...
                                                    <?php }?>
                                                    <?php if($exa1['respuestaCorecta'] == 2){ ?>
                                                    <tr style="background-color: green;">
                                                        <td>
                                                    ...
                                                    <?php }?>
                                                    <?php if($exa1['respuestaCorecta'] == 3){ ?>
                                                    <tr style="background-color: green;">
                                                        <td>
                                                    ...
                                                    <?php }?>
                                                    <?php if($exa1['respuestaCorecta'] == 4){ ?>
                                                    <tr style="background-color: green;">
                                                        <td>
