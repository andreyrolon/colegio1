...
<script src="../../../bower_components/select2/dist/js/select2.min.js"></script>
    ...
    document.getElementById('ww').style.display='block';
        ...
        $.ajax({
            type: "post",
            url: "../../../ajax/docente/logro.php?action=curso_logro",
            data: {nomd,
                id_a,
                id_g,
                id_c, 
         ...
         $(document).on("submit", "#tinti", function(e){
                      ...
                      $.ajax({
                        ...
                        type: "post",
                      url: "../../../ajax/docente/logro.php?action=masivo_registro", 
                        data: $(this).serialize(),
                        dataType:"text", 
                        success: function(data)
                        { 
