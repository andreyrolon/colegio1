                    ...
                    <div class="col-md-9">
                        <div class=" " style="border-top:solid 3px #00c0ef; background: #fff; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);"> <?php  
                            ...
                            foreach($var as $key){ 
                                ...
                                if ($key['reenvio']!=0) {
                                    ...
                                    foreach ($variable as $ke) {  
                                        ...
                                        $foto1=$_SESSION['Fot'];
                                        if ($_SESSION['Fot']=='' and $_SESSION['genero']==1) {
                                            $foto1='../../../logos/femenino.png';
                                        } if ($_SESSION['Fot']=='' and $_SESSION['genero']==0){
                                            ...
                                            <div class="box-body" style="display: none;">
                                                ...
                                                <div class=" " style='margin-left: 10px'>
                                                    <div class=" " style=""><br>
                                                        ...
                                                        <strong>Rol:</strong><span > Docente</span><br> 
                                ...
                                <form action="" id="formulario-envia" name="formulario-envia" method="post" enctype="multipart/form-data">
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <select name="usuario" id="usuario" class="form-control" onchange="myFunction()" required>
                                                <option value=""></option>
                            ...
                            <div id="ver" style="display: none;">
                                ...
                                <input type="hidden" value="<?php echo $tabled1 ?>" id="tabla2" name="tabla2">
                                <div class="box-body">
                                    <div class="form-group">
...
<script>
    ...
    e.preventDefault();  
        ...
        $.ajax({
            ...
            data:parametros,
            url:"../../../ajax/docente/mensaje.php?action=reenvio",
            type:"POST",
            contentType:false,
            processData:false,
            success: function(data){
