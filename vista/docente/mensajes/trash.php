                        ...
                        <div class="box box-solid" style=" box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
                            ...
                            <div class="box-body no-padding">
                                <ul class="nav nav-pills nav-stacked">
                                    <li ><a href="mailbox.php"><i class="fa    fa-folder-open-o"></i> Bandeja de entrada
                                            <?php if ($mensaje[0]>0){ ?>
                                    ...
                                    <li class="active"><a href="trash.php"><i class="fa fa-trash-o"></i> Papelaria</a></li>
                                </ul>
                            </div>
                            <!-- /.box-body -->
                        </div>
    ...
    <script type="text/javascript">
        for (var i = 0; i < 100; i++) {
            function myFunction(i) {
                ...
                $.ajax({
                    type: "post",
                    url: "../../../ajax/docente/tabla_mensaje.php?action=tabla1",
                    data: {
                        i,
                        dato,
                        mySelect,
