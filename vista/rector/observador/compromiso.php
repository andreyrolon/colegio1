            ...
            <div class="modal-content" id="cotent">
              <div class="modal-header" id="header" style="">
                <button type="button" class="close" data-dismiss="modal">
                 ...
                 <strong>Actualizar Compromiso </strong>
              </div>
              ...
              <div class="modal-body" id="body" >
                ...
                <textarea type=" " class="form-control" id="compromiso"  name="" style="text-transform:uppercase;height: 152px; " onkeyup="javascript:this.value=this.value.toUpperCase();"></textarea><br>
                 
              </div>
              <div class="modal-footer">
                <button class="btn btn-primary" onclick="let id=$('#id').val();
                let nombre=$('#compromiso').val();let dato=$('#dato').val(); actualizar(nombre,id,dato)">Actualizar</button>
            ...
            <div class="box box-info"  style="  box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
              <form   method="post">
                <div class="box-header with-border"  >
                  <strong>Crear Compromiso</strong>
                </div>
                <div class="box-body">
                  <!-- the events --> 
                  Descripcion del compromiso: <br> 
                  <textarea type="text" class="form-control" id="nombre" style="text-transform:uppercase;height: 140px" onkeyup="javascript:this.value=this.value.toUpperCase();"></textarea><br>
  ...
  <script type="text/javascript">
    ...
    function mostrar_tabla(){ 
      ...
      $.ajax({  
        ...
        type: "post", 
        url:"../../../ajax/rector/observador/observador.php?action=mostrar_compromiso",
        dataType:"text", 
    ...
    function registrar(nombre){  
      ...
      $.ajax({  
        ...
        type: "post", 
        data:{nombre},
        url:"../../../ajax/rector/observador/observador.php?action=registrar_compromiso",
        dataType:"text", 
    ...
    function actualizar(nombre,id,dato){  
      ...
      $.ajax({  
        ...
        type: "post", 
        data:{nombre,id,dato},
        url:"../../../ajax/rector/observador/observador.php?action=actualizar_compromiso",
        dataType:"text", 
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                  ...
                  $.ajax({  
                    ...
                    type: "post", 
                    data:{id},
                    url:"../../../ajax/rector/observador/observador.php?action=eliminar_compromiso",
                    dataType:"text", 
