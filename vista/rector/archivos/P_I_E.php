         ...
         <br> 
          <div class="col-md-11 "  id="r">
            <div style="background-color: #fff;  box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
             <div style="background-color: #28A5E6;padding: 10px"><div style="  color: #fff">  <strong>PROYECTO EDUCATIVO INSTITUCIONAL</strong> </div></div>
              <div class="modal-body table-responsive" id="pdf"> 
                <form name="formulario-envia" id="formulario-envia" enctype="multipart/form-data" method="post">
                      <div class="btn btn-default btn-file">
                          ...
                          <i class="fa fa-file-pdf-o"></i> Cambiar docemento
              ...
              <iframe  src="../../../archivos_colegio/PIE.pdf" style="border:solid 1.2px;width:100%;height: 900px" frameborder="0"></iframe></div>
            </div>
          </div>
        </div>
      </div>
...
$('.select2').select2({    
 ...
 function sasa() { mostrar();
    ...
    $.ajax({
      data:parametros,
      url:"../../../ajax/rector/archivos/archivos.php?action=PIE",
      type:"POST",
      contentType:false,
      processData:false,
