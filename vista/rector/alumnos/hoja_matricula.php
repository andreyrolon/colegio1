...
<table style="padding-left: 25px;padding-right:  10px;padding-top: 5px;width:780px">
	<tbody>
		...
		<tr class="centra1 ">
			...
			<th rowspan="6	"  style="padding: 0px;width: 100px;height: 110px;background: #fff"> <img src="imagenes/2.jpg" style="width: 98px;height: 110px"> </th>
		</tr>
		<tr class="titulcol centra">
...
<table style="padding-left: 25px;padding-right:  10px;width: 776px">
	<tbody>
		...
		<tr class="centra">
			<td class=" " style="width:100px">'.$_GET['nuevo1'].'</td>
			<td class="anchor1" colspan="2	">'.$_GET['colegio_origen'].'</td> 
			<td class="anchor1">'.$fecha.'</td>
			<td class="anchor1">'.$ano.'</td>
...
<table style="padding-left: 25px;padding-right:  10px;  ">
	<tbody>
		...
		if ($_GET['nombre_mama']!='') {
			$html.='
			<tr class="centra">
				<td class="anchor1">'.$_GET['nombre_mama'].'</td>
				<td class="anchor1">'.$_GET['apellido_mama'].'</td>
				<td class="anchor1">'.$_GET['tipo_documento_mama'].'</td>
				<td class="anchor1">'.$_GET['numero_documento_mama'].'</td>
				<td class="anchor1">'.$_GET['expedida_mama'].'</td>
			</tr>';
		} 
		if ($_GET['nombre_papa']!='') {
			$html.='
			<tr class="centra">
				<td class="anchor1">'.$_GET['nombre_papa'].'</td>
				<td class="anchor1">'.$_GET['apellido_papa'].'</td>
				<td class="anchor1">'.$_GET['tipo_documento_papa'].'</td>
				<td class="anchor1">'.$_GET['numero_documento_papa'].'</td>
				<td class="anchor1">'.$_GET['expedida_papa'].'</td>
			</tr>';
		} 
		if ($_GET['nombre_acudiente']!='') {
			$html.='
			<tr class="centra">
				<td class="anchor1">'.$_GET['nombre_acudiente'].'</td>
				<td class="anchor1">'.$_GET['apellido_acudiente'].'</td>
				<td class="anchor1">'.$_GET['tipo_documento_acudiente'].'</td>
				<td class="anchor1">'.$_GET['numero_documento_acudiente'].'</td>
				<td class="anchor1">'.$_GET['expedida_acudiente'].'</td>
			</tr>';
		} 
	 	$html.='
		<tr class="titulcol centra">
		...
		if ($_GET['nombre_mama']!='') {
			$html.='
			<tr class="centra">
				<td class="anchor1">Mama</td>
				<td class="anchor1">'.$_GET['direccion_mama'].'</td>
				<td class="anchor1">'.$_GET['barrio_mama'].'</td>
				<td class="anchor1">'.$_GET['telefono_mama'].'</td>
				<td class="anchor1">'.$_GET['ocupacion_mama'].'</td>
			</tr>';
		} 
		if ($_GET['nombre_papa']!='') {
			$html.='
			<tr class="centra">
				<td class="anchor1">Papa</td>
				<td class="anchor1">'.$_GET['direccion_papa'].'</td>
				<td class="anchor1">'.$_GET['barrio_papa'].'</td>
				<td class="anchor1">'.$_GET['telefono_papa'].'</td>
				<td class="anchor1">'.$_GET['ocupacion_papa'].'</td>
			</tr>';
		} 
		if ($_GET['nombre_acudiente']!='') {
			$html.='
			<tr class="centra">
				<td class="anchor1">'.$_GET['parentesco'].'</td>
				<td class="anchor1">'.$_GET['direccion_acudiente'].'</td>
				<td class="anchor1">'.$_GET['barrio_acudiente'].'</td>
				<td class="anchor1">'.$_GET['telefono_acudiente'].'</td>
				<td class="anchor1">'.$_GET['ocupacion_acudiente'].'</td>
			</tr>';
		} 
		$html.='
		<tr class="centra titulcol">
			<td  class="anchor1" colspan="2">Ocupacion</td>
		...
		if ($_GET['nombre_mama']!='') {
			$html.='
			<tr class="centra">
				<td colspan="2">'.$_GET['ocupacion_mama'].'</td>
				<td colspan="2">'.$_GET['direccion_trabajo_mama'].'</td>
				<td>'.$_GET['telefono_trabajo_mama'].'</td>
	        </tr>';
        } 
		if ($_GET['nombre_papa']!='') {
			$html.='
			<tr class="centra">
				<td colspan="2">'.$_GET['ocupacion_papa'].'</td>
				<td colspan="2">'.$_GET['direccion_papa'].'</td>
				<td>'.$_GET['telefono_trabajo_papa'].'</td>
	        </tr>';
        } 
		if ($_GET['nombre_acudiente']!='') {
			$html.='
			<tr class="centra">
				<td colspan="2">'.$_GET['ocupacion_acudiente'].'</td>
				<td colspan="2">'.$_GET['direccion_trabajo_acudiente'].'</td>
				<td>'.$_GET['telefono_trabajo_acudiente'].'</td>
	        </tr>';
        } 
		$html.='
