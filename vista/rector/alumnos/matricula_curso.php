        ...
        <div class="row"> 
          ...
          <div class="col-md-4">
            ...
            <div class="box box-info " style=" box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
              <div class="box-body">
                <div id="validacion"></div> 
                <strong>Seleccione el curso que dese hacer la matricula</strong><br><br>
                <label for="curso">Sedes y jornadas:</label>
                <select class="form-control select2" id="jornada_sede1" name="jornada_sede1" required></select>   <br>
               <label for="curso" id="fri" style="display:  ;">Cursos:</label>          
               <select class="form-control select2" id="curso1" name="curso1" onchange=" buscar1()"  required></select>    <br>
               <label for="curso" id="fri" style="display:  ;">Año:</label>          
               <select class="form-control " id="ano"  required>
               	<?php $ano=date("Y");  ?>
               		<option value="<?php echo $ano ?>"><?php echo $ano ?></option>
               		<option value="<?php echo $ano+1 ?>"><?php echo $ano+1 ?></option>
               </select><br><br> 
              	<button class="btn btn-block btn-info"> Matricula por curso</button>
  ...
  function mostrar(){
   ...
   function buscar(){
      ...
      $.ajax({  
        ...
        url:"../../../ajax/rector/alumno/matricula_curso.php?action=buscar",
