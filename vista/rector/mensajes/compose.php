                    ...
                    <div class="col-md-9">
                        <div class="box box-primary" style=" box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
                            <div class="box-header with-border">
                                <nav class="box-title">Redactar nuevo mensaje</nav>
                            </div>
                            <!-- /.box-header -->
                            <div id="sapo"></div>
    ...
    function myFunction() {
        ...
        if (first_name==5) { 
            ...
            $.ajax({
                ...
                type: "post",
                url: "../../../ajax/rector/mensaje.php?action=consultar_docente",
                ...
                success: function(data) {
                    $.ajax({
                        ...
                        type: "post",
                        url: "../../../ajax/seles/seles.php?action=sacar_sede_jornadax", 
                        dataType: "text",
        ...
        if (first_name==6) { 
         ...
         //si el mensaje es para todos los admin
