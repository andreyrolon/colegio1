...
function tabla()
   { 
    ...
    <?php  
     ...
     SELECT nota_tecnologica_independiente.id_nota_tecnologica_independiente,nota_tecnologica_independiente.nombre,examen_tecnica.id_examen_tecnica,examen_tecnica.minutos,examen_tecnica.fecha,examen_tecnica.hora,tecnica_por_paso.nota,tecnica_por_paso.id_tecnica_por_paso FROM nota_tecnologica_independiente INNER JOIN  tecnica_por_paso ON tecnica_por_paso.id_nota_tecnologia_independiente=nota_tecnologica_independiente.id_nota_tecnologica_independiente  INNER JOIN  examen_tecnica ON nota_tecnologica_independiente.id_nota_tecnologica_independiente=examen_tecnica.id_nota_tecnologica_independiente  WHERE   tecnica_por_paso.id_informe_academico=$id_informe_academico  AND  nota_tecnologica_independiente.id_grado=$id_grado AND nota_tecnologica_independiente.id_jornada_sede=$id_jornada_sede AND nota_tecnologica_independiente.id_curso=$id_curso and nota_tecnologica_independiente.id_competencia=$partes[1] ORDER BY  examen_tecnica.id_examen_tecnica desc";
                ...
                <tbody>
                    ...
                    foreach($con2 as $var){
                        ...
                        <tr>
                            ...
                            <td><?php   
                                if($var['nota']==0){ ?>
                                    <a  id="i"  data-title="Aún no has respondido el examen" style="  ;"  >
                                    ...
                                    <a    id="examen_R<?php echo($for); ?>" onclick="click_query2(<?php echo($var[0]); ?>,<?php echo $var['nota']?>)"     data-title="puedes visualizar los resultados" >
                                        <img width="47"  src="data:image/svg+xml;utf8;base64," />
                                    </a><?php
                                }?>
                            </td>
                            ...
                            <td> <?php 
                                if($var['nota']==0){ 
                                    ...
                                    if($var['fecha']<$fecha_actual){?>
                                        <a   disabled   data-title="la fecha ya paso"  style=" cursor: not-allowed;">
                                            <img width="47"  src="data:image/svg+xml;utf8;base64," />
                                        </a> <?php
                                    }
                                }else{ ?>
...
{   
    ...
    if (($tiempo>=$base) && ($tiempo<$final)){
        ...
        $sql2="SELECT examen_tecnica_pregunta.id_examen_tecnica_pregunta as id,pregunta,respuesta1,respuesta2,respuesta3,respuesta4,examen_tecnica_pregunta.respuesta_correcta FROM examen_tecnica_pregunta WHERE examen_tecnica_pregunta.id_nota_tecnologica_independiente=$id ";
        ...
        <div id="ver"> 
            ...
            <form role="form" action="" method="post" id="formulario-envia">
                ...
                <input type="hidden" value="<?php echo $_POST['id_tecnica_por_paso'] ?>" name='id_tecnica_por_paso'>
                ...
                foreach($con2 as $key){
                    ...
                    <div style="display: none;"  class='tab' id="tabla<?php echo $r ?>">
                        <div    style=" border: solid 2px #33b5e5;" >
                            ...
                            <input type="hidden" value="<?php echo $key['respuesta_correcta'] ?>" name='respuesta_c[]'>
            ...
            <script>
                $(document).on("submit", "#formulario-envia", function(e){
                    ...
                    $.ajax({
                        ...
                        type: "post",
                        url: "../../../ajax/alumno/examen_tecnico.php?action=insertR", 
                        data: $(this).serialize(),
                        dataType:"text", 
...
function insertR()
{
    ...
    $id_tecnica_por_paso=$_POST['id_tecnica_por_paso'];
    $id_informe_academico=$_SESSION['id_informe_academico'];
    $con1=0;
    $i=0;
    $tex="";
    foreach ($respuesta_c as $key ) {
        ...
        if (isset($_POST['respuesta'.$i])) {
            ...
            $tex.="INSERT INTO `examen_tecnica_respuesta` ( `id_nota_tecnologica_independiente`, `id_examen_tecnica_pregunta`, `id_respuesta`, `id_alumno`) VALUES ( '$id_notas_independientes', '".$_POST['pregunta'.$i]."', '".$_POST['respuesta'.$i]."', '$id_informe_academico');";
   ...
   echo $sql="$tex UPDATE `tecnica_por_paso` SET `nota` = '$t' WHERE `tecnica_por_paso`.`id_tecnica_por_paso` = ".$id_tecnica_por_paso;
    $sql1=$conexion->prepare($sql);
    $sql1->execute(array());
        ...
        <div class="modal-dialog modal-lg"   >
            <div class="modal-content" >
                ...
                <div class="modal-body ">  <?php
                    $sql="SELECT examen_tecnica_pregunta.id_examen_tecnica_pregunta as id,examen_tecnica_pregunta.pregunta,examen_tecnica_pregunta.respuesta1,examen_tecnica_pregunta.respuesta2,examen_tecnica_pregunta.respuesta3,examen_tecnica_pregunta.respuesta4,examen_tecnica_pregunta.respuesta_correcta,q.respuesta from examen_tecnica_pregunta LEFT JOIN (SELECT examen_tecnica_pregunta.id_examen_tecnica_pregunta as  id, examen_tecnica_respuesta.id_respuesta as respuesta FROM examen_tecnica_pregunta INNER JOIN examen_tecnica_respuesta ON examen_tecnica_respuesta.id_examen_tecnica_pregunta=examen_tecnica_pregunta.id_examen_tecnica_pregunta WHERE examen_tecnica_pregunta.id_nota_tecnologica_independiente=$id AND examen_tecnica_respuesta.id_alumno=$alum) as q on q.id=examen_tecnica_pregunta.id_examen_tecnica_pregunta WHERE examen_tecnica_pregunta.id_nota_tecnologica_independiente=$id GROUP BY examen_tecnica_pregunta.id_examen_tecnica_pregunta";
                    $sql1=$conexion->prepare($sql);
                    $sql1->execute(array());
                    $exa=$sql1->fetchAll();
                    $n=0;
                    ...
                    foreach($exa as $exa1){
                        ...
                        $id=0;
                        if ( $exa1['respuesta']==$exa1['respuesta_correcta'] ) {
                        ...
                        <div class="col-md-6" style=" ">
                            <div class="table table-responsive" style="border: solid 2px <?php echo $color ?>;">
                                <table class="table     ">
                                    ...
                                    <tr>
                                        <th  style="   background-color: <?php echo $color ?>;">
                                    ...
                                    <tr>
                                        <td <?php echo $clas1 ?> id='respuesta<?php echo $exa1['id'] ?>1'>
                                            <div  class="espacio">
                                    ...
                                    <tr>
                                        <td  <?php echo $clas2 ?> id='respuesta<?php echo $exa1['id'] ?>2'>
                                            <div class="espacio" >
                                    ...
                                    <tr>
                                        <td <?php echo $clas3 ?> id='respuesta<?php echo $exa1['id'] ?>3'>
                                            <div class="espacio">
                                    ...
                                    <tr>
                                        <td <?php echo $clas4 ?> id='respuesta<?php echo $exa1['id'] ?>4'>
                                            <div class="espacio">
                    ...
                    <div class="modal-footer">    
                                          <div class="col-md-12">      
                        <button type="button" class="btn btn-primary" data-dismiss="modal" style=" ">Cerrar</button></div>
                    </div>
                </div>  
            </div>
        </div>
