...
?> 
            ...
            <tr>
              ...
              if ( $key['tabla_de']==1) { ?>
                ...
                <td style='padding:15px;'><a href="abrir_mensaje.php?id=<?php echo $key['id'] ?>"><?php echo $key[9].' '.$key[10] ?></a></td> <?php
              }
              if ( $key['tabla_de']==2) { ?>
              ...
              if ( $key['tabla_de']==6) { ?>
                ...
                <td style='padding:15px;'><a href="abrir_mensaje.php?id=<?php echo $key['id'] ?>"><?php echo $key[5].' '.$key[6] ?></a></td> <?php

              } 

              if (  $key['tabla_de']==5) { ?>
                <td style='padding:15px;'><center><span class="label label-info pull-left">Docente</span></center></td>
                <td style='padding:15px;'><a href="abrir_mensaje.php?id=<?php echo $key['id'] ?>"><?php echo $key[7].' '.$key[8] ?></a></td> <?php 
              } ?>
...
?> 
          ...
          <tr>
              <?php  if ( $key['tabla_de']==1) { ?>
                <td style='padding:15px;'><center><span class="label label-primary pull-left">Rector</span></center></td>
                <td style='padding:15px;'><a href="mensaje_eliminado.php?id=<?php echo $key['id'] ?>"><?php echo $key[9].' '.$key[10] ?></a></td> <?php
              } 
              if ( $key['tabla_de']==2) { ?>
                <td style='padding:15px;'><center><span class="label label-primary pull-left">Coordinador</span></center></td>
                <td style='padding:15px;'><a href="mensaje_eliminado.php?id=<?php echo $key['id'] ?>"><?php echo $key[9].' '.$key[10] ?></a></td> <?php
              ...
              if ( $key['tabla_de']==6) { ?>
                <td style='padding:15px;'><center><span class="label pull-left bg-teal">Alumno</span></center></td>
                <td style='padding:15px;'><a href="mensaje_eliminado.php?id=<?php echo $key['id'] ?>"><?php echo $key[5].' '.$key[6] ?></a></td> <?php

              } 

              if (  $key['tabla_de']==5) { ?>
                <td style='padding:15px;'><center><span class="label label-info pull-left">Docente</span></center></td>
                <td style='padding:15px;'><a href="mensaje_eliminado.php?id=<?php echo $key['id'] ?>"><?php echo $key[7].' '.$key[8] ?></a></td> <?php 
              } ?>
...
function envios(){     
  ...
  $id=$_POST['id'];
   ...
   $consultar_nivel="SELECT   mailbox.id , mailbox.dirigido,    mailbox.fecha, mailbox.asunto from mailbox   WHERE mailbox.de='$id' and mailbox.tabla_de=6 AND mailbox.asunto like('%$d%')    ORDER BY id  DESC  "; 
  $consultar_nivel1=$conexion->prepare($consultar_nivel);
  $consultar_nivel1->execute(array()); 
  $registro=$consultar_nivel1->fetchAll();
  $nroProductos=$consultar_nivel1->rowCount();
            ...
            <tbody> <?php
              foreach (array_slice($registro, $limit, $nroLotes) as  $key) {
                ...
                <tr>
                  ...
                  if ($key['dirigido']==1) { ?>
                    <span class="label label-info pull-left">Rector</span>  <?php
                  }  

                  if ($key['dirigido']==3  ) { ?> <span class="label pull-left label-info">Psicoorientador</span>  <?php

                  } 
                  if ($key['dirigido']==4  ) { ?> <span class="label pull-left label-info">Secretaria</span>  <?php

                  } 
                  if ($key['dirigido']==5  ) { ?> <span class="label pull-left label-info">Docentes</span>  <?php

                  } 

                  if ($key['dirigido']==6 ) { ?> <span class="label pull-left label-info">Alumnos</span>  <?php

                  } 
                  if ($key['dirigido']==2) { ?> <span class="label label-info label-info">Coordinador</span>  <?php 
                  } ?>
                  </td>
                  <td style='padding:15px;' class="mailbox-subject">
                    <a href="mensaje_enviado.php?id=<?php echo $key['id'] ?>"><?php echo($key['asunto']); ?></a>
                  </td>
                  <td  style='padding:15px;'class="mailbox-date">
